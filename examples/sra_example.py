...
def main(cfg_path, mountpoint, data_folder, foreground=True):
    ...
    projection_filesystem.projection_manager = SRAProjector(projection_driver,
                                                                     root_projection,
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m_p', '--mount_point', help='specifies mount point path on host')
    parser.add_argument('-d_d', '--data_directory', help='specifies data directory path on host')
    parser.add_argument('-cfg', '--config_path', help='specifies projection configuration YAML file path')
