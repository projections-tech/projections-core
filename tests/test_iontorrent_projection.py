...
class TestTorrentSuiteProjector(TestCase):
    ...
    def test_full_projection(self):
        ...
        self.assertEqual(len(projection_paths_list), 37,
                         msg='Checking total number of projections, expecting 37, got: {}.'.format(len(projection_paths_list)))
        ...
        for exp_dir in exp_dirs:
            ...
            for i in range(1, 6):
                ...
                bam_file_path = os.path.join(exp_dir, run_name, 'sample_{}'.format(i), 'sample_{}.bam'.format(i))
                ...
                sample_meta_path = os.path.join(exp_dir, run_name, 'sample_{}'.format(i), 'metadata.json')
